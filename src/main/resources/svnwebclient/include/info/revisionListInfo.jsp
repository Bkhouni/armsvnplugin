...
%>        
        <td class="value" nowrap="true" style="padding-left:20px;padding-top:5px;">
            <input type="checkbox" name="hidepolarioncommit" id="hidepolarioncommit" checked onchange='window.location="<%=bean.getButtonUrl().getHidePolarionCommitUrl()%>"'/>
        </td>
<%
        } else {
%>
        <td class="value" nowrap="true" style="padding-left:20px;padding-top:5px;">
            <input type="checkbox" name="hidepolarioncommit" id="hidepolarioncommit" onchange='window.location="<%=bean.getButtonUrl().getHidePolarionCommitUrl()%>"'/>
        </td>
<%
        }
%>
        <td class="value" nowrap="true" style="padding-top:5px;">
            Hide Polarion revisions
        </td>
<%        
    }        
%>
