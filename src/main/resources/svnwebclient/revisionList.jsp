...
<%@ page import="org.polarion.svnwebclient.decorations.IIconDecoration,
		org.polarion.svnwebclient.web.model.data.RevisionList"
%>
...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="SVN Web Client - Revision List"/>
    </jsp:include>
    <body>
                                        ...
                                        <tr>
                                            <td class="internal" width="16px" style="padding-right:5px;">
                                                <a href="<%=element.getRevisionInfoUrl()%>">
                                                   <img src="images/show_affected_path.gif " alt="Revision changes" title="Revision changes" border="0"></img>
                                                </a>
                                            </td>                                          
                                            <td class="internal" width="16px">
<%
...
%>                
                                                <a href="<%=element.getDownloadUrl()%>">
                                                   <img src="images/download.gif" alt="Download" title="Download" border="0"></img>
                                                </a>
<%
            }                                            
%>            
