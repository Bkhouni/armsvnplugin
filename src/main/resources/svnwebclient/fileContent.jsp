...
<%@ page import="org.polarion.svnwebclient.web.model.data.file.FileContent" %>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" height="99%">
            ...
            <tr>
                <td width="100%" height="100%" style="padding:0px;spacing:0px; padding-left:5px; padding-right:7px;">
                    <iframe scrolling="no" class="frame" id="content_frame" name="content_frame" width="100%" height="100%" frameborder="0" src="<%=bean.getSelectedViewUrl()%>">
                        <a href="<%=bean.getSelectedViewUrl()%>">Content</a>                        
                    </iframe>
                </td>
            </tr>
            <tr>
