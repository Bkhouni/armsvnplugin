...
/**
 * Created by IntelliJ IDEA. User: detkin Date: 27/05/2005 Time: 13:11:18 To
...
public class SubversionProperties implements SvnProperties {
	...
	public String toString() {
		return "username: " + getUsername() + " password: " + getPassword()
				...
				+ " revisioningIndex: " + getRevisionIndexing()
				+ " revisioningCacheSize: " + getRevisionCacheSize();
	}
	...
	public SubversionProperties setRevisioningCacheSize(
			Integer revisioningCacheSize) {
