...
<%@ page 	contentType="text/html; charset=UTF-8"
			import="org.polarion.svnwebclient.decorations.IIconDecoration,
                 org.polarion.svnwebclient.web.model.data.StatsUser,
                 org.polarion.svnwebclient.web.model.data.directory.DirectoryContent,
...
%>            
                            ...
                            <input type="hidden" name="comments" multiple="yes" value="" />
...
%>            
                                            ...
                                            <td class="internal" width="16px" style="padding-right:5px;">
                                                <a href="<%=element.getRevisionListUrl()%>"><img src="images/revlist.gif" alt="Revision list" title="Revision list" border="0"></img></a>
                                            </td>                                        
                                           <td class="internal" width="16px" style="padding-right:5px;">
                                                <a href="<%=element.getCommitGraphUrl()%>"><img src="images/commit_graph_blue.png" alt="Commit graph" title="Commit graph" border="0"></img></a>
                                            </td>                                        
                                            <td class="internal" width="16px" style="padding-right:5px;">
                                                <a href="<%=element.getStatisticsUrl()%>"><img src="images/stats.gif" alt="Statistics" title="Statistics" border="0"></img></a>
                                            </td>                                        
...
%>            
                                ...
                                <td nowrap="true">
                                    <a href="<%=StatsUser.getUrl(element.getAuthor())%>"><%=element.getAuthor()%></a>
                                </td>
<%                                
