...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="SVN Web Client - Review"/>
    </jsp:include>
    <body>
        <table cellspacing="0" cellpadding="0" width="100%" height="100%" border="0">
            <form method="POST" action="sendEmail.jsp">
                ...
                <input type="hidden" name="letter" value="<%=bean.getEncodedLetterContent()%>"/>                      
                <input type="hidden" name="falseSend" value="falseSend"/>                      
                ...
                <tr>
                    <td style="padding:0;spacing:0px; padding-left:5px; padding-right:5px; padding-top:5px;padding-bottom:5px;" height="100%">
                        <jsp:include page="include/dialog.jsp">
                            <jsp:param name="jsp.dialog.title" value="Error Report Preview"/>
