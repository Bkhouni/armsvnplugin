...
%>	                
        <td align="left">
        	<input type="button" class="button" value="Ok" onclick="window.location='<%=bean.getRestrictLoginUrl()%>'"/>
        </td>
<%
	}
%>                    
        <td align="left" style="padding-left:10px;">
       		<input type="button" class="button" value="Cancel" onclick="window.location='<%=bean.getFullRootPageUrl()%>'"/>
        </td>
        <td width="100%"/>
    </tr>
</table>
