...
<%@ page import="org.polarion.svnwebclient.decorations.IIconDecoration,
                 org.polarion.svnwebclient.web.model.data.directory.PickerDirectoryContent,
...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="SVN Web Client - Directory Content"/>
    </jsp:include>
                                    ...
                                    <table class="internalheader" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="background:#75A8E2;padding-right:5px;">  
                                                <a href="<%=sortManager.getSortUrl(DirectoryContentSortManager.FIELD_NAME)%>">
                                                    Name
                                                </a>
                                            </td>
<%
...
%>        
                                ...
                                <th nowrap="true" width="5%">
                                    <table class="internalheader" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="background:#75A8E2;padding-right:5px;">  
                                                <a href="<%=sortManager.getSortUrl(DirectoryContentSortManager.FIELD_REVISION)%>">
                                                    Revision
                                                </a>
                                            </td>
<%
...
%>        
                                ...
                                <th nowrap="true" width="5%">
                                    <table class="internalheader" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="background:#75A8E2;padding-right:5px;">  
                                                <a href="<%=sortManager.getSortUrl(DirectoryContentSortManager.FIELD_SIZE)%>">
                                                    Size
                                                </a>
                                            </td>
<%
...
%>        
                                ...
                                <th nowrap="true" width="5%">
                                    <table class="internalheader" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="background:#75A8E2;padding-right:5px;">  
                                                <a href="<%=sortManager.getSortUrl(DirectoryContentSortManager.FIELD_DATE)%>">
                                                    Date
                                                </a>
                                            </td>
<%
...
%>        
                                ...
                                <th nowrap="true" width="10%">
                                    <table class="internalheader" cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td style="background:#75A8E2;padding-right:5px;">  
                                                <a href="<%=sortManager.getSortUrl(DirectoryContentSortManager.FIELD_AUTHOR)%>">
                                                    Author
                                                </a>
                                            </td>
<%
...
%>          
                                <td nowrap="nowrap">
                                    <a href="#" style="text-decoration: none;" onclick='performAction(<%=element.getPickerSelectUrlSrcipt()%>);return false;'>
                                    <img src="images/pick_repo_url.gif" alt="Select this url" title="Select this url"/>
...
%>
                                                <img src="images/head.gif" alt="Head revision" title="Head revision" border="0"/>
<%
            } else {
%>                  
...
%>
                            <tr>
                                <td colspan="7" align="center">
                                    <b>Directory is empty. There are no items to show</b>
                                </td>
                            </tr>
<%
        }
...
%>            
            ...
            <tr>
                <td style="padding-left:5px; padding-right:5px;padding-bottom:10px;" width="100%">
                    <input type="button" value="Add selected items" title="Add selected items to Picker List" class="button" onclick="pickerAction('add', 'dir_list')" />
                </td>
            </tr>    
...
<!--            summary           -----------------------------   -->            
            ...
            <tr>
               <td style="padding-left:5px; padding-right:5px;padding-top:15px;" width="100%" class="message">
                    <b>Picker selected items list:</b>
               </td>     
            </tr>
...
%>                               
                            ...
                            <tr onmouseover="selectRow(this)" onmouseout="deselectRow(this)">   
                                <td>
                                    <a onclick='removeResource("remove_list", <%=id%>)'>
    				                    <img src="images/minus.gif" alt="Remove revision from list" title="Remove item" valign="middle" border="0">
    				                </a> 
                                </td>
...
%>                                            
            ...
            <tr>
                <td style="padding:0;spacing:0px; padding-left:5px; padding-right:5px;padding-bottom:10px;" width="100%">
                    <input type="button" value="Ok" class="button" onclick='populateForm("remove_list")' />
                </td>
            </tr>            
<%
    }
