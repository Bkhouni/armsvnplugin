...
<%@ page import="org.polarion.svnwebclient.web.model.data.directory.DirectoryCompare" %>
...
<html>
    <jsp:include page="include/head.jsp">
        <jsp:param name="jsp.head.title" value="SVN Web Client - Directory Revision Comparison"/>
    </jsp:include>
    <body>
