...
public class UpdateShareConnectionsAction extends JiraWebActionSupport {
	...
	public UpdateShareConnectionsAction(ActiveObjects ao, ALMMultipleSubversionRepositoryManager manager) {
	...
	public String doDefault() {
		...
		try {
			...
			cp.setShareConnections(!cp.getShareConnections(), ao);
		} catch (Exception e) {
			log.error(e.getMessage());
			addError("shareConnections", e.getMessage());
			return ERROR;
		}
